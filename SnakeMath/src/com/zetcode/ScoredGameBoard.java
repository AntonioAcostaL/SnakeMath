...
public class ScoredGameBoard extends GameComponent implements Scoreable, ActionListener {
    ...
    public ScoredGameBoard(SnakeMath frame, Player player, GameInfoPanel infoPanel) {
        ...
        super(300, 300, GameStyles.BACKGROUND_COLOR);
    ...
    protected void renderComponent(Graphics g) {
        ...
        g2d.scale(SCALE, SCALE); // Aplica el factor de escalado
        ...
        if (inGame) {
            ...
            // Solo hacer visible el botón al perder, y evitar agregarlo repetidamente
            if (!returnToMenuButton.isVisible()) {
                ...
                returnToMenuButton.setVisible(true); // Hacer visible solo cuando el juego termine
            }
        }
    }
